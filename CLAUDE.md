Actúa como un Desarrollador Full-Stack Senior y arquitecto de software. Vas a construir la plataforma completa "Portify", un sistema de tarjetas de presentación digitales dinámicas basado en el documento de requerimientos adjunto.
...
1. `/[slug]`: Portify pública visible para cualquier visitante sin autenticación.
